...
defmodule AshJsonApi.OpenApi do
  ...
  defp query_parameters(%{type: type} = route, resource) when type in [:get, :related] do
    [include_parameter(), fields_parameter(resource)] ++ read_argument_parameters(route, resource)
  end
        ...
        data: %Schema{
          ...
          properties: %{
            ...
            relationships: %Schema{
              ...
              required: required_relationship_attributes(resource, relationship_arguments, action)
            }
          }
        }
      }
